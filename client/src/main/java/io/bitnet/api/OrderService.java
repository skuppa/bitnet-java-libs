...
* <p>
* The Bitnet interface has a number of optional parameters for fetching Orders. These are handled with overloaded methods.
* The params are: accountId, reference, state, offset, limit
*/
