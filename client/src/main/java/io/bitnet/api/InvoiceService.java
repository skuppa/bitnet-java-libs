...
* <p>
* The Bitnet interface has a number of optional parameters for fetching Invoices. These are handled with overloaded methods.
* The params are: accountId, orderId, paymentAddress, reference, state, transitionedTo, transitionedOn, offset, limit
*/
