...
import io.bitnet.notifications.model.NotificationEventTypes;
...
public class NotificationHelperTest {
    ...
    public void shouldParseInvoiceNotification() throws IOException {
        ...
        assertThat(notificationHelper.getNotificationEventType(body), is(NotificationEventTypes.INVOICE_EXPIRED));
    ...
    public void shouldParseOrderNotification() throws IOException {
        ...
        assertThat(notificationHelper.getNotificationEventType(body), is(NotificationEventTypes.ORDER_STATE_CHANGED));
