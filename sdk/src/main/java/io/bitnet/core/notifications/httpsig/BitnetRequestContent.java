...
/**
 * This is a copy of https://github.com/adamcin/httpsig-java/blob/eb328ec93c9cb26e2bfead5b00568cb31d20ad3d/api/src/main/java/net/adamcin/httpsig/api/RequestContent.java
 ...
 * Updated Classname to BitnetRequestContent
 * Updated SimpleDateFormat in tryParseDate to use English locale. Submitted Patch will be to allow the Builder to set a locale to use for dates, this has not been implemented here to keep changes minimal.
 *
 ...
 */
public final class BitnetRequestContent implements Serializable {
    private static final Logger LOGGER = Logger.getLogger(BitnetRequestContent.class.getName());
    ...
    private BitnetRequestContent(final String requestLine, final String method, final String path, final Map<String, List<String>> headers) {
    ...
    public static final class Builder {
         ...
         * @return true if the date header was successfully set. false if date is already set
         */
        public Builder addDate(Calendar calendar, String dateFormatString) {
            if (calendar != null) {
        ...
        public BitnetRequestContent build() {
            return new BitnetRequestContent(requestLine, method, path, Collections.unmodifiableMap(headers));
        }
    }
    ...
    /**
     * @return the list of header names contained in this {@link BitnetRequestContent}, in the order in which they were added, except
